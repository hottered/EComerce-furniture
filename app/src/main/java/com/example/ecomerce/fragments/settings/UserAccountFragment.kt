...
class UserAccountFragment : Fragment(R.layout.fragment_user_account) {
    ...
    private lateinit var imageAcitivityResultLauncher:ActivityResultLauncher<Intent>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        
        imageAcitivityResultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imageEdit.setOnClickListener{
            ...
            intent.type = "image/*"
            imageAcitivityResultLauncher.launch(intent)
        }
    }
